 ...
 */
class ClassNamesInArray implements \de\codenamephp\platform\di\definitionsProvider\dependency\handler\iHandler {
   ...
   * @var string[]
   */
  private $collectedDependencies = [];

  /**
   *
   * @return string[]
   */
  public function getCollectedDependencies() {
   ...
   * @return $this
   */
  public function setCollectedDependencies(array $collectedDependencies) {
   ...
   * @return $this
   */
  public function addDependencies(array $dependenciesToAdd) {
   ...
   */
  public function handle(iDependency $provider) {
